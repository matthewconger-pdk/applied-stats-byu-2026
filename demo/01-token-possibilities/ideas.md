...
We start with a specific, but open-ended prompt for a limerick about a cougar.

```markdown
Write a funny limerick about a cougar.
```

Try replacing `cougar` with `animal`.
